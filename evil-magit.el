  ...
  (let ((states (if evil-magit-use-y-for-yank
    ...
    (append
     `((,states magit-mode-map "g")
       (,states magit-mode-map "C-k"   magit-section-forward          "n")
       (,states magit-mode-map "gk"    magit-section-forward-sibling  "M-n")
       (,states magit-mode-map "]"     magit-section-forward-sibling  "M-n")
       (,states magit-mode-map "C-l"   magit-section-backward         "p")
       ...
       (,states magit-mode-map "C-S-k"   evil-scroll-down)
     ...
     `((,states magit-status-mode-map "gz"  magit-jump-to-stashes                  "jz")
       ...
       (,states magit-diff-mode-map "gk" magit-section-forward)
     ...
     (if evil-magit-use-y-for-yank
         `((,states magit-mode-map "v"    evil-visual-line)
           (,states magit-mode-map "V"    evil-visual-line)
           (,states magit-mode-map "M-v"  evil-visual-line)
...
(defvar evil-magit-minor-mode-map-bindings
  `(((,evil-magit-state visual) magit-blob-mode-map "gk" magit-blob-next     "n")
    ((,evil-magit-state visual) magit-blob-mode-map "gl" magit-blob-previous "p")
    ((,evil-magit-state visual) git-commit-mode-map "gk" git-commit-prev-message "M-p")
    ((,evil-magit-state visual) git-commit-mode-map "gl" git-commit-next-message "M-n")
    ((normal) magit-blame-read-only-mode-map "k"    evil-next-visual-line)
    ((normal) magit-blame-read-only-mode-map "C-k"  magit-blame-next-chunk                 "n")
    ((normal) magit-blame-read-only-mode-map "gk"   magit-blame-next-chunk                 "n")
    ((normal) magit-blame-read-only-mode-map "gK"   magit-blame-next-chunk-same-commit     "N")
    ((normal) magit-blame-read-only-mode-map "l"    evil-previous-visual-line)
    ((normal) magit-blame-read-only-mode-map "C-l"  magit-blame-previous-chunk             "p")
    ((normal) magit-blame-read-only-mode-map "gl"   magit-blame-previous-chunk             "p")
    ((normal) magit-blame-read-only-mode-map "gl"   magit-blame-previous-chunk-same-commit "P"))
  ...
  `(progn
     ...
     (defvar evil-magit-rebase-commands-w-descriptions
       ...
       '(("p"    git-rebase-pick           "pick = use commit")
         ...
         ("l"    evil-previous-visual-line "move point to previous line" "p")
         ("k"    evil-next-visual-line     "move point to next line" "n")
         ("M-l"  git-rebase-move-line-up   "move the commit at point up" "\M-p")
         ("M-k"  git-rebase-move-line-down "move the commit at point down" "\M-n")
